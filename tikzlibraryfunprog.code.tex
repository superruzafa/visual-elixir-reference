...
\let\funprog@datastruct@type\empty
...
\pgfkeys{
	/tikz/use funprog/.append code={
		\pgfkeys{
			/tikz/.cd,
			%
			datastruct id/.store in=\funprog@datastruct@id,
			datastruct element/.store in=\funprog@datastruct@element,
			datastruct type/.store in=\funprog@datastruct@type,
			element/.forward to=/tikz/datastruct element,
			%
			every function/.style={},
			function/.prefix style={funprog,function=##1},
			arity/.prefix style={funprog,function/arity=##1},
			in/.prefix style={funprog,function/in=##1},
			out/.prefix style={funprog,function/out=##1},
			%
			every list/.style={},
			every list elements between/.style={},
			list/.prefix style={funprog,list=##1},
			index/.prefix style={funprog,\funprog@datastruct@type/index=##1},
			elements between/.prefix style={funprog,\funprog@datastruct@type/elements between=##1},
			%
			every iteration/.style={},
			iteration/.prefix style={funprog, iteration=##1},
			starting iteration/.prefix style={funprog, starting iteration=##1},
			from left to right/.prefix style={funprog, iteration/from left to right=##1},
			from right to left/.prefix style={funprog, iteration/from right to left=##1},
		}
	}
}
...
\pgfkeys{
	...
	list/.style={
		datastruct id=#1,
		datastruct element=#1,
		datastruct type=list,
		name=list #1,
		nodes={
			draw,
			anchor=center,
...
\def\funprog@iteration@direction@lefttoright{1}
\def\funprog@iteration@direction@righttoleft{2}
\let\funprog@iteration@direction\funprog@iteration@direction@lefttoright

\newlength\funprog@iteration@radius
\setlength\funprog@iteration@radius{1cm}

\pgfkeys{
	/tikz/funprog/.cd,
	iteration/iteration ->/.style={
		every iteration,
		-{Stealth[angle=37.5:2.5mm,flex]},
		shorten >=0.5mm,
	},
	iteration/<- iteration/.style={
		every iteration,
	...
	iteration/.style={
		...
		decoration={
			...
			lineto code={
				\ifnum\funprog@iteration@direction=\funprog@iteration@direction@lefttoright
					\draw [#1, funprog/iteration/iteration ->, bend left=60] (\tikzinputsegmentfirst) to (\tikzinputsegmentlast);
				\fi
				\ifnum\funprog@iteration@direction=\funprog@iteration@direction@righttoleft
					\draw [#1, funprog/iteration/iteration ->, bend left=-60] (\tikzinputsegmentfirst) to (\tikzinputsegmentlast);
				\fi
			},
		}
	},
	starting iteration/.style={
		decorate,
		decoration={
			show path construction,
			moveto code={
				\ifnum\funprog@iteration@direction=\funprog@iteration@direction@lefttoright
					\draw [#1, funprog/iteration/<- iteration] (\tikzinputsegmentfirst) arc [radius=\funprog@iteration@radius, start angle=45, end angle=85];
				\fi
				\ifnum\funprog@iteration@direction=\funprog@iteration@direction@righttoleft
					\draw [#1, funprog/iteration/<- iteration] (\tikzinputsegmentfirst) arc [radius=\funprog@iteration@radius, start angle=135, end angle=95];
				\fi
			},
			lineto code={
				\ifnum\funprog@iteration@direction=\funprog@iteration@direction@lefttoright
	...
	iteration/from left to right/.code={
		\let\funprog@iteration@direction\funprog@iteration@direction@lefttoright
	},
	iteration/from right to left/.code={
		\let\funprog@iteration@direction\funprog@iteration@direction@righttoleft
	},
}
