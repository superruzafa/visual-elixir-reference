...
\let\funprog@datastructelementsize\empty
...
\pgfkeys{
  ...
  data struct element size/.store in=\funprog@datastructelementsize,
...
\pgfkeys{
  ...
  tuple/.style={
    ...
    nodes={
      ...
      inner sep=0pt,
      outer sep=0pt,
      minimum height=\funprog@datastructelementsize,
    },
  ...
  tuple/placeholder/.style={
    node contents={},
    minimum width=#1 * \funprog@datastructelementsize,
  },
  ...
  tuple/index/.style={
    ...
    minimum width=\funprog@datastructelementsize,
  },
}
...
\pgfkeys{
  ...
  map/.style={
    ...
    nodes={
      ...
      inner sep=0pt,
      outer sep=.5\pgflinewidth,
      minimum size=\funprog@datastructelementsize,
    },
    column sep=-\pgflinewidth,
    row sep=-\pgflinewidth,
    outer sep=-.5\pgflinewidth,
  ...
  map/key value/.style 2 args={
    ...
    append after command={
      \pgfextra
      \draw [line width=.75\pgflinewidth] ($(\tikzlastnode.west) + (\pgflinewidth, 0) $) -- ($ (\tikzlastnode.east) + (-\pgflinewidth, 0) $);
...
\pgfkeys{
  ...
  empty collection/.style={
    ...
    outer sep=.5\pgflinewidth,
    minimum height=\funprog@datastructelementsize,
    minimum width=.3 * \funprog@datastructelementsize,
  },
}
...
\pgfkeys{
  funprog,
  iteration/position/.initial=top,
  iteration/direction/.initial=from left to right,
  iteration/enter/top/from left to right/.style={
    decorate,
    decoration={
      show path construction,
      moveto code={
        \draw [start angle=30, end angle=90, radius=1cm, every enter iteration, #1] (\tikzinputsegmentfirst) arc;
      },
    }
  },
  iteration/enter/top/from right to left/.style={
    decorate,
    decoration={
      show path construction,
      moveto code={
        \draw [start angle=150, end angle=90, radius=1cm, every enter iteration, #1] (\tikzinputsegmentfirst) arc;
      },
    }
  },
  iteration/direct/top/from left to right/.style={
    decorate,
    decoration={
      show path construction,
      lineto code={
        \draw [bend left=45, every iteration, #1] (\tikzinputsegmentfirst) to (\tikzinputsegmentlast);
      },
    }
  },
  iteration/direct/top/from right to left/.style={
    decorate,
    decoration={
      show path construction,
      lineto code={
  ...
  iteration/exit/top/from left to right/.style={
    decorate,
    decoration={
      show path construction,
      moveto code={
        \draw [start angle=150, end angle=90, radius=1cm, every exit iteration, #1] (\tikzinputsegmentfirst) arc;
      },
    }
  },
  iteration/exit/top/from right to left/.style={
    decorate,
    decoration={
      show path construction,
      moveto code={
        \draw [start angle=30, end angle=90, radius=1cm, every exit iteration, #1] (\tikzinputsegmentfirst) arc;
      },
    }
  },
}
    ...
    decoration={
      ...
      lineto code={
        \path let
          ...
          \n1={veclen(\x3, \y3)},
          \p4=(-\y3 / \n1, \x3 / \n1),
          \n2={\pgfkeysvalueof{/funprog/measure amplitude}},
          \n3={\pgfkeysvalueof{/funprog/measure overflow} * sign(\pgfkeysvalueof{/funprog/measure amplitude})}
        in
