...
\newcommand\funprog@currcoord{\the\tikz@lastxsaved,\the\tikz@lastysaved}
...
\pgfkeys{
    /tikz/use funprog/.append code={
        \pgfkeys{
			...
			port width/.prefix style={funprog,function/port width=##1},
			port height/.prefix style={funprog,function/port height=##1},
			port funnel width/.prefix style={funprog,function/port funnel width=##1},
			port separation/.prefix style={funprog,function/port separation=##1},
			north ports/.prefix style={funprog,function/north ports=##1},
            south ports/.prefix style={funprog,function/south ports=##1},
            east ports/.prefix style={funprog,function/east ports=##1},
            west ports/.prefix style={funprog,function/west ports=##1},
            %
            every list/.style={},
            ...
            elements before/.prefix style={funprog,\funprog@datastruct/elements before=##1},
            elements between/.prefix style={funprog,\funprog@datastruct/elements between=##1},
            elements after/.prefix style={funprog,\funprog@datastruct/elements after=##1},
			%
			every measure/.style={},
			every measure label/.style={},
			measure/.prefix style={funprog,measure=##1},
			measure distance/.prefix style={funprog,measure distance=##1},
			measure overflow/.prefix style={funprog,measure overflow=##1},
        }
    }
}
...
\let\funprog@measure@label\empty
\let\funprog@measure@distance\empty
\let\funprog@measure@overflow\empty

\pgfkeys{
    /tikz/funprog/.cd,
	every measure/.style={},
	every measure label/.style={},
	measure label/.store in=\funprog@measure@label,
	measure overflow/.store in=\funprog@measure@overflow,
	measure overflow=2mm,
	measure distance/.store in=\funprog@measure@distance,
	measure distance=1cm,
	measure ->/.style={
		-{Latex}
	},
	measure/.style={
		...
		decoration={
			...
			lineto code={
				\draw
					[line width=0.1mm]
					(\tikzinputsegmentfirst) -- ++(0, \funprog@measure@distance) -- ++(0, \funprog@measure@overflow)
					(\tikzinputsegmentlast) -- ++(0, \funprog@measure@distance) -- ++(0, \funprog@measure@overflow)
					;
					\path (\tikzinputsegmentfirst) -- ++(0, \funprog@measure@distance) -- node [every measure label] (last label) {\funprog@measure@label} (\funprog@currcoord -| \tikzinputsegmentlast)
				;
				\draw [funprog/measure ->] (last label.west) -- (last label.west -| \tikzinputsegmentfirst);
				\draw [funprog/measure ->] (last label.east) -- (last label.east -| \tikzinputsegmentlast);
			}
		},
	}
}
