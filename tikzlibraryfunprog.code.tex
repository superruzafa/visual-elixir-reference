...
\let\funprog@struct@id\empty
\let\funprog@struct@element\empty
\let\funprog@struct@type\empty

\pgfkeys{
    /tikz/use funprog/.append code={
        \pgfkeys{
            /tikz/.cd,
            struct/.store in=\funprog@struct@type,
            struct id/.store in=\funprog@struct@id,
            element/.store in=\funprog@struct@element,
            index/.prefix style={funprog, \funprog@struct@type/index=##1},
            elements between/.prefix style={funprog, \funprog@struct@type/elements between=##1},
...
\pgfkeys{
    /tikz/funprog/.cd,
        ...
        list/index/.style={
            name=\funprog@struct@id#1,
            node contents={$\funprog@struct@element_{#1}$},
            draw,
        },
        list/elements between/.style={
            ...
            append after command={
                \pgfextra
                    \draw [dashed] (\tikzlastnode.north west) -- (\tikzlastnode.north east);
                \draw [dashed] (\tikzlastnode.south west) -- (\tikzlastnode.south east);
                \endpgfextra
            },
        },
}
