...
\let\funprog@element\empty
\let\funprog@struct\empty

\pgfkeys{
    /tikz/use funprog/.append code={
        \pgfkeys{
            /tikz/.cd,
            struct/.store in=\funprog@struct,
            element/.store in=\funprog@element,
            index/.prefix style={funprog, \funprog@struct/index=##1},
            elements between/.prefix style={funprog, \funprog@struct/elements between=##1},
