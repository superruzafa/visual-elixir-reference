...
\def\funprog@datastruct@elementpadding{0}
...
\tikzset{
  ...
  element padding/.forward to={funprog, data struct element padding},
...
\pgfkeys{
  ...
  data struct element padding/.store in=\funprog@datastruct@elementpadding,
...
\pgfkeys{
  ...
  list/placeholder/.style={
    ...
    alias={\funprog@datastructid placeholder\the\value{placeholder}},
    node contents={},
    minimum width=#1 * \funprog@datastruct@elementsize + 2 * \funprog@datastruct@elementpadding,
    minimum height=\funprog@datastruct@elementsize + 2 * \funprog@datastruct@elementpadding,
  },
  list/index/.style={
    alias=\funprog@datastructid#1,
    node contents={$\funprog@datastructelement_{#1}$},
