...
\begin{scope}
  \matrix [list=b, element size=1.5cm, above=1.25 of zb] {
    \node [index=1]; &
    \node [elements between]; &
    \node [index=n]; \\
  };

  \matrix [list=c, element size=1.5cm, above=1.25 of zc] {
    \node [index=1]; &
    \node [elements between]; &
    \node [index=m]; \\
  };

  \matrix [list=k, element size=1.5cm, above=1.25 of zk] {
    \node [index=1]; &
    \node [elements between]; &
    \node [index=p]; \\
  };
...
\matrix [list=a, above=4.5 of list z] {
  \node [index=1]; &
  \node [index=2]; &
  \node [elements between]; &
  \node [index=n]; \\
